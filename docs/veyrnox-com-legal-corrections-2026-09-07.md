...
The app-side half is already fixed in code: PR #2378 aligned §8/§9/§10/§11, and the PR that
adds this file completes it (the exclusivity claims elsewhere in the policy, the consent
control §9 promised, and regression pins for all of it).
