...
| `veyrnox-elliptic-upstream-watch.md` | Tue 09:34 | Registry-only watch for a patched `elliptic`, or any link in the Keystone chain dropping it. Re-pointed 2026-08-25 — it previously probed the Ledger and Trezor chains, which no longer exist in the tree. |
...
|---|---|---|---|
| `elliptic` | 5 low | No upstream fix at any version (6.6.1 is `latest`); single chain via `@keystonehq/keystone-sdk`; the Keystone device signs | elliptic-upstream-watch, re-pointed at the Keystone chain 2026-08-25 |
