/**
 * TIP Intelligence Dashboard — CSS-in-JS (Styled Components)
 *
 * Installation:
 * npm install styled-components
 *
 * Usage:
 * import { StatCardStyled, DataTableStyled } from './TIP-SENTINEL-STYLED-COMPONENTS';
 */

import styled from 'styled-components';

// ============================================================================
// THEME OBJECT (Use with ThemeProvider)
// ============================================================================
...
export const StatCardContainer = styled.div`
  ...
  &.stat-card--allow {
    .stat-card__value { color: ${props => props.theme.colors.semantic.success}; }
  }

  &.stat-card--warn {
    .stat-card__value { color: ${props => props.theme.colors.semantic.warning}; }
  }

  &.stat-card--block {
    .stat-card__value { color: ${props => props.theme.colors.semantic.danger}; }
  }
`;
...
export const StatCardMeta = styled.div`
  font-size: ${props => props.theme.typography.fontSize.small};
  color: ${props => props.theme.colors.text.secondary};
  line-height: 1.4;
`;
...
export const TableCell = styled.td`
  ...
  font-family: ${props => props.mono ? props.theme.typography.fontFamily.mono : 'inherit'};
  font-size: ${props => props.mono ? props.theme.typography.fontSize.small : props.theme.typography.fontSize.body};
  color: ${props => props.mono ? props.theme.colors.text.secondary : props.theme.colors.text.primary};
  font-variant-numeric: tabular-nums;
`;
...
export const ModalDialog = styled.div`
  ...
  ${props => {
    switch (props.size) {
      case 'sm': return 'width: 90%; max-width: 400px;';
      case 'lg': return 'width: 90%; max-width: 800px;';
      default: return 'width: 90%; max-width: 600px;';
    }
  }}
