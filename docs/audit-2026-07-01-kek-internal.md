...
|----------|-------|-----------------------|------|
| CRITICAL | 1 | 0 → **1** (C-1 RESOLVED / device-verified 2026-07-02) | 0 — C-1 closed: PR #529 merged (commit 732f9676); Pixel 10 Pro XL Sepolia send txid `0xeb71a5d31a8794682cf681d8ebb2916967c1097e951519dcf1b53327d2d8e580`, block 11185289; vault `hardwareKekVersion:2`, `kekSaltLength:44` confirmed |
