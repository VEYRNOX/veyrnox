...
were then deleted from origin. All four are **BUILT / unit-tested only — NOT
device-verified, NOT independently audited; no on-chain txid is involved.** Per-item detail
