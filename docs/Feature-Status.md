...
type guard) — see the table above.** Remaining open items (M-1, M-4, M-8, M-9, M-10,
L-1, L-2, L-3, L-5) must not be marked resolved until the owner confirms a resolution.
