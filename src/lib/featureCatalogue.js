    ...
    features: [
      {
        ...
        explanation:
          ...
          'Blocklist expanded from 4 to 22 entries.',
      },
      {
        name: 'Web3 Browser',
        status: 'roadmap',
