  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        status: 'built',
        summary: 'Optional extra OS-biometric factor at every unlock, on top of PIN + KEK. Face on iOS (face-strict); any strong biometric on Android (no public API to require face specifically).',
