        ...
        <div className="space-y-5">
          ...
          {pinStep === "real" && (
            <div className="space-y-3 text-center">
              ...
              <p className="text-xs text-muted-foreground">This unlocks your wallet. An 8-digit PIN is strong against a quick grab, but not against someone who keeps your device to try PINs offline — so guard the device itself.</p>
