...
export default function WalletCard({ wallet, onClick }) {
  return (
    <button
      ...
      className="w-full text-start group relative overflow-hidden rounded-xl border border-border bg-card p-5 transition-[transform,background-color,border-color,box-shadow] duration-200 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
    >
