...
const ALL_ROUTES = [
  ...
  { path: "/swap", label: "Swap", icon: ArrowDownUp, group: "Wallet" },
  { path: "/dex", label: "DEX Swap", icon: Shuffle, group: "Wallet" },
  { path: "/bridge", label: "Cross-Chain Bridge", icon: GitMerge, group: "Wallet" },
  ...
  { path: "/fiat", label: "Fiat Ramp", icon: CreditCard, group: "Wallet" },
  { path: "/fiat-wallets", label: "Fiat Wallets", icon: DollarSign, group: "Wallet" },
  { path: "/calculator", label: "Convert", icon: BarChart3, group: "Wallet" },
  { path: "/staking", label: "Staking", icon: Zap, group: "Invest" },
  { path: "/dca", label: "DCA", icon: Repeat, group: "Invest" },
  { path: "/rebalance", label: "Rebalance", icon: Sliders, group: "Invest" },
  { path: "/lending", label: "Lending", icon: Landmark, group: "Invest" },
  { path: "/yield", label: "Yield Farming", icon: Sprout, group: "Invest" },
  { path: "/options", label: "Options", icon: BarChart3, group: "Invest" },
  { path: "/pl", label: "P&L Tracking", icon: TrendingUp, group: "Invest" },
  { path: "/trading-bots", label: "Trading Bots", icon: Bot, group: "Invest" },
  { path: "/social-trading", label: "Social Trading", icon: Copy, group: "Invest" },
  { path: "/risk", label: "Risk Scoring", icon: ShieldCheck, group: "Invest" },
  { path: "/savings", label: "Savings Goals", icon: Target, group: "Finance" },
  { path: "/loans", label: "Crypto Loans", icon: Banknote, group: "Finance" },
  { path: "/invoices", label: "Invoice Generator", icon: FileText, group: "Finance" },
  { path: "/tax", label: "Tax Report", icon: Receipt, group: "Finance" },
  { path: "/dao", label: "DAO Governance", icon: Vote, group: "Finance" },
  ...
  { path: "/kyc", label: "Verification", icon: ShieldCheck, group: "Security" },
