      ...
      <Card>
        <CardContent className="pt-4 space-y-3">
          <div className="flex gap-2">
            <Input aria-label="DApp URL" placeholder="app.uniswap.org or paste a dApp URL" maxLength={2048} value={url} onChange={(e) => setUrl(e.target.value)} onKeyDown={(e) => e.key === "Enter" && handleCheck()} />
