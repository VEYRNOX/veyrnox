// src/pages/__tests__/FeeAnalytics.refetch-i3.test.js
...
describe('FeeAnalytics #1120 refetch I3 gate', () => {
...
describe('RULE3 exemption removed for FeeAnalytics', () => {
  it('not in RULE3_LEGACY_EXEMPT_PATHS', () => {
    ...
    expect(m[1]).not.toMatch(/FeeAnalytics/);
  });
});