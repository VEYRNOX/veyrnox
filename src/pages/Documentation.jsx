...
const features = [
  ...
  { category: "Referrals", icon: Users, items: [
    { name: "Referral Tracker", desc: "Share your referral code to earn rewards; tier-based commissions and discounts apply to eligible paid subscriptions, including Safety Plus and AI Security Protection. Using this feature sends your referral code, chosen plan, and purchase/discount amounts to VEYRNOX's servers so earnings can be tracked — the referral service never receives your balances, your wallet addresses, or your seed phrase. Claiming a payout is separate and opens an email you write yourself, so you choose what payment details to include.", status: "built" },
  ]},
