...
export default function SendCrypto() {
  ...
  const { isUnlocked, wallets: liveWallets, activeWalletId, switchWallet, accounts, btcAccount, solAccount, withPrivateKey, withBtcPrivateKey, withSolPrivateKey, lock, verifyActiveCredential, isSendReauthRequired } = useWallet();
