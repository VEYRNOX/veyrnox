...
const DAPP_LOGOS = {
  ...
  'Aave': (
    <svg viewBox="0 0 32 32" fill="none" width="36" height="36" preserveAspectRatio="xMidYMid meet"><rect width="32" height="32" rx="8" fill="#2EBAC6"/><path d="M21.5 23h-2.8l-1.5-3.8h-.4L15.3 23H12.5L16 13.5h.5l1.2 3h.1l1.2-3h.5L21.5 23zm-6.5-5.5h2l-1-2.8-1 2.8z" fill="#fff"/></svg>
  ),
  'Curve': (
