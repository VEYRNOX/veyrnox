...
const DAPP_LOGOS = {
  'Uniswap': (
    <svg aria-hidden="true" viewBox="0 0 32 32" fill="none" width="36" height="36" preserveAspectRatio="xMidYMid meet"><rect width="32" height="32" rx="8" fill="#FF007A"/><path d="M12.5 8c1.2 0 2 .3 2 .3s-.3 1.2.5 1.8c.8.6 2.2.4 3.2 1.2 1.5 1.2 1 3.5.8 4.5-.2 1-.8 2.3-.2 3.5.4.8 1.2 1.2 1.2 1.2s-1 .5-1.8 1.8c-.6 1-.5 2.2-.5 2.2H14s.1-1-.5-2c-.5-.8-1.5-1.2-2-2.5-.5-1.5 0-3 .5-4s1-2 .5-3.2C12 11.6 11 11 11 11s.5-1.5.8-2c.2-.5.7-1 .7-1zm6 1.5c0 .5.4.8.8.8s.8-.3.8-.8-.4-.8-.8-.8-.8.3-.8.8z" fill="#fff"/></svg>
  ),
  '1inch': (
    <svg aria-hidden="true" viewBox="0 0 32 32" fill="none" width="36" height="36" preserveAspectRatio="xMidYMid meet"><rect width="32" height="32" rx="8" fill="#1B314F"/><path d="M17.5 7c1 0 2.5 1.5 2.5 1.5l-1 2s1.5.5 2 2c.5 1.5-.5 3-1 4s-1 2.5-.5 4c.3 1 1 1.5 1 1.5l-1.5 2s-1-.5-2-1.5c-1.5-1.5-2-3.5-1.5-5.5.3-1 .8-2 .5-3-.2-.8-.8-1.2-.8-1.2L17.5 7z" fill="#D82122"/><circle cx="19" cy="10" r=".8" fill="#D82122"/></svg>
  ),
  'PancakeSwap': (
    <svg aria-hidden="true" viewBox="0 0 32 32" fill="none" width="36" height="36" preserveAspectRatio="xMidYMid meet"><rect width="32" height="32" rx="8" fill="#633001"/><ellipse cx="16" cy="19" rx="7" ry="5" fill="#D1884F"/><ellipse cx="16" cy="17.5" rx="7" ry="5" fill="#FEDC90"/><circle cx="13" cy="12" r="3" fill="#D1884F"/><circle cx="19" cy="12" r="3" fill="#D1884F"/><circle cx="13" cy="11.5" r="2.2" fill="#FEDC90"/><circle cx="19" cy="11.5" r="2.2" fill="#FEDC90"/><circle cx="12.5" cy="11" r=".6" fill="#633001"/><circle cx="19.5" cy="11" r=".6" fill="#633001"/></svg>
  ),
  'Aave': (
    <svg aria-hidden="true" viewBox="0 0 32 32" fill="none" width="36" height="36" preserveAspectRatio="xMidYMid meet"><rect width="32" height="32" rx="8" fill="#2EBAC6"/><path d="M21.5 23h-2.8l-1.5-3.8h-.4L15.3 23H12.5L16 13.5h.5l1.2 3h.1l1.2-3h.5L21.5 23zm-6.5-5.5h2l-1-2.8-1 2.8z" fill="#fff"/></svg>
  ),
  'Curve': (
    <svg aria-hidden="true" viewBox="0 0 32 32" fill="none" width="36" height="36" preserveAspectRatio="xMidYMid meet"><rect width="32" height="32" rx="8" fill="#000"/><path d="M8 20c2-4 5-8 10-10" stroke="#FF0000" strokeWidth="2.5" strokeLinecap="round" fill="none"/><path d="M10 22c2-4 5-8 10-10" stroke="#F7EC00" strokeWidth="2.5" strokeLinecap="round" fill="none"/><path d="M12 24c2-4 5-8 10-10" stroke="#0000FF" strokeWidth="2.5" strokeLinecap="round" fill="none"/></svg>
  ),
  'OpenSea': (
    <svg aria-hidden="true" viewBox="0 0 32 32" fill="none" width="36" height="36" preserveAspectRatio="xMidYMid meet"><rect width="32" height="32" rx="8" fill="#2081E2"/><path d="M9 17.5l.2-.3 4-6.2c.1-.1.2-.1.3 0 .7 1.3 1.2 2.8 1 4.3-.1.6-.4 1.2-.8 1.8l-.1.2c0 .1-.1.1-.2.1H9.2c-.1 0-.2-.1-.2-.2v.3zm14 1.5v1c0 .1 0 .1-.1.2-1.5.6-2.5 1.8-3.2 3.3 0 .1-.1.1-.2.1h-2.2c-.1 0-.2-.1-.2-.2 0-2.5 1.8-4.7 4.2-5.3.1 0 .2 0 .2.1.3.3.5.5.5.8z" fill="#fff"/></svg>
  ),
  'Blur': (
    <svg aria-hidden="true" viewBox="0 0 32 32" fill="none" width="36" height="36" preserveAspectRatio="xMidYMid meet"><rect width="32" height="32" rx="8" fill="#FF6F00"/><path d="M15.5 18.5c0-.55.45-1 1-1s1 .45 1 1-.45 1-1 1-1-.45-1-1zm1-6c.55 0 1 .45 1 1v2.5c0 .55-.45 1-1 1s-1-.45-1-1v-2.5c0-.55.45-1 1-1zm0 8c.55 0 1 .45 1 1v1c0 .55-.45 1-1 1s-1-.45-1-1v-1c0-.55.45-1 1-1z"/><circle cx="16" cy="20" r="1" fill="#fff"/></svg>
  ),
  'GMX': (
    <svg aria-hidden="true" viewBox="0 0 32 32" fill="none" width="36" height="36" preserveAspectRatio="xMidYMid meet"><rect width="32" height="32" rx="8" fill="#2D42FC"/><path d="M8 16l4-6h3l-4 6 4 6h-3l-4-6zm8 0l4-6h3l-4 6 4 6h-3l-4-6z" fill="#fff"/></svg>
  ),
  'LFJ': (
  ...
  'Balancer': (
    <svg aria-hidden="true" viewBox="0 0 32 32" fill="none" width="36" height="36" preserveAspectRatio="xMidYMid meet"><rect width="32" height="32" rx="8" fill="#111"/><circle cx="16" cy="11" r="2.6" fill="#fff"/><circle cx="12.5" cy="17" r="2" fill="#fff"/><circle cx="19.5" cy="17" r="2" fill="#fff"/><circle cx="13" cy="22" r="1.4" fill="#fff"/><circle cx="19" cy="22" r="1.4" fill="#fff"/></svg>
  ),
  'Compound': (
    <svg aria-hidden="true" viewBox="0 0 32 32" fill="none" width="36" height="36" preserveAspectRatio="xMidYMid meet"><rect width="32" height="32" rx="8" fill="#070A0E"/><path d="M16 7a9 9 0 1 0 0 18 9 9 0 0 0 0-18zm0 3a6 6 0 1 1 0 12 6 6 0 0 1 0-12z" fill="#00D395"/><circle cx="16" cy="16" r="2.4" fill="#00D395"/></svg>
  ),
  'Lido': (
    <svg aria-hidden="true" viewBox="0 0 32 32" fill="none" width="36" height="36" preserveAspectRatio="xMidYMid meet"><rect width="32" height="32" rx="8" fill="#00A3FF"/><path d="M16 7l4.5 7-4.5 2.6L11.5 14 16 7z" fill="#fff"/><path d="M16 17.4l4.8-2.8c1 1.9.8 4.3-.8 5.9a5.6 5.6 0 0 1-8 0c-1.6-1.6-1.8-4-.8-5.9L16 17.4z" fill="#fff" opacity=".7"/></svg>
  ),
  'Pendle': (
    <svg aria-hidden="true" viewBox="0 0 32 32" fill="none" width="36" height="36" preserveAspectRatio="xMidYMid meet"><rect width="32" height="32" rx="8" fill="#1B1E2B"/><path d="M9 22V10h5a4 4 0 0 1 0 8h-2" stroke="#28E0AE" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" fill="none"/></svg>
  ),
};
