...
describe('asset status gating (Phase B)', () => {
  ...
  it('the ERC-20s are now live alongside the verified natives (ETH, USDC, USDT, MATIC, ARB, OP, BNB, BTC, SOL)', () => {
    expect(ASSETS_LIVE()).toEqual(['ETH', 'USDC', 'USDT', 'MATIC', 'ARB', 'OP', 'BNB', 'BTC', 'SOL']);
  });
});
