...
export function deriveEvmAddress(mnemonic, accountIndex = 0, passphrase = '') {
  ...
  //
  // #1113: master node's privateKey must also be wiped — it can derive every
  // child key on every chain. Hoisted to a variable so the finally block can
  // zero it alongside seed and acctPriv.
