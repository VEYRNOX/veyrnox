...
- **Step 0 present** — follow the runbook as written. Step 0's lockfile read is expected; any other repo file access is not, and the lockfile must come from the ref (`git show origin/main:package-lock.json`), never the working tree.
